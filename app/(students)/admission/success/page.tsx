        ...
        <main className="flex-grow py-12 flex items-center justify-center">
          <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center max-w-md mx-auto space-y-4">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              No student ID parameter was detected. Please complete the
              registration and payment checklist.
            </p>
            <div className="pt-2">
              <Link
                href="/"
      ...
      <div className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-blue-900 selection:text-white">
        ...
        <main className="flex-grow py-12 flex items-center justify-center">
          <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center max-w-md mx-auto space-y-4">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              The database does not contain any completed admission logs for
              this student ID.
            </p>
            <div className="pt-2">
              <Link
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-lg text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Thank you, <strong>{student.name}</strong>. Your online
                admission forms and simulated checkout payment have been
            ...
            <div className="grid grid-cols-1 gap-3 pt-2">
              ...
              >
                <FileText className="h-4 w-4" /> Print Payment Receipt (Coming
                Soon)
              </button>
            </div>
