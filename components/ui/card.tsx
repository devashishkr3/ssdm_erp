...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Stronger shadow + border for crisp edge definition
        // Slightly warmer bg tint separates card from page
        "group/card flex flex-col gap-6 overflow-hidden rounded-2xl bg-card text-sm text-card-foreground",
        "shadow-md ring-1 ring-foreground/12",
        "py-6",
